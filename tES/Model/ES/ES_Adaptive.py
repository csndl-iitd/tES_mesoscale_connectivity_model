...
class ES_Adaptive:
    ...
    def __init__(self, 
        ...
        Parameters:
            - adjacency_matrix (numpy.mat): The adjacency matrix representing the network.
    ...
    def run_model(self):
        ...
        for i in range(self.NEPOCHS):
            ...
            if self.plot_hysteresis:
                
                if (i % self.epochs_per_lambda_o == 0): 
                    if i // (self.NEPOCHS / 2) == 1:
            ...
            coupling = self.LAMBDA_O*np.multiply(self.ADAPTIVE_COUPLING, wts)
